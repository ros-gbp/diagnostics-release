## diagnostics (noetic) - 1.10.2-3

The packages in the `diagnostics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro noetic` on `Tue, 08 Sep 2020 12:54:24 -0000`
...
## diagnostics (noetic) - 1.10.2-2

The packages in the `diagnostics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro noetic` on `Sat, 05 Sep 2020 18:27:38 -0000`
...
## diagnostics (noetic) - 1.10.2-1

The packages in the `diagnostics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro noetic` on `Fri, 04 Sep 2020 06:59:52 -0000`
...
## diagnostics (melodic) - 1.9.7-1

The packages in the `diagnostics` repository were released into the `melodic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro melodic` on `Thu, 03 Sep 2020 09:20:17 -0000`
...
## diagnostics (melodic) - 1.9.6-1

The packages in the `diagnostics` repository were released into the `melodic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro melodic` on `Thu, 20 Aug 2020 07:28:57 -0000`
...
## diagnostics (noetic) - 1.10.0-1

The packages in the `diagnostics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release diagnostics --rosdistro noetic` on `Tue, 11 Aug 2020 10:11:43 -0000`
...
## diagnostics (kinetic) - 1.9.3-0

The packages in the `diagnostics` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --non-interactive --rosdistro kinetic --track kinetic diagnostics` on `Wed, 02 May 2018 17:37:24 -0000`
